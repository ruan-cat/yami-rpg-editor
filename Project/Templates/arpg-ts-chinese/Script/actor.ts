...
class ActorCollider {
	...
	/** 处理两个角色之间的碰撞 */
	public static handleCollisionBetweenTwoActors: (
		sActor: Actor,
		dActor: Actor,
		ratio?: number
	) => void = (IIFE => {
	 ...
	 * @param dCell 场景角色分区2
	 */
	private static handleCollisionsBetweenTwoCells = (
		sCell: Array<Actor>,
		dCell: Array<Actor>
	): void => {
...
class TargetManager {
	 ...
	 * @returns 目标池中符合条件的角色实例
	 */
	public getTargetMinAttributeValue(
		selector: ActorSelector,
		key: string
	): Actor | undefined {
		let target: Actor | undefined;
	 ...
	 * @returns 目标池中符合条件的角色实例
	 */
	public getTargetMaxAttributeRatio(
		selector: ActorSelector,
		key: string,
		divisor: string
	): Actor | undefined {
