...
CommandSuggestion.pointerdown = function (event) {
	...
	if (!widget.contains(event.target) && !list.contains(event.target)) {
		event.preventDefault()
		Window.close('command-widget')
	}
}
...
CommandSuggestion.list.createComment = function (item) {
	...
	if (item.class !== 'folder' && !/^en/.test(Local.language)) {
		...
		const string =
			item.class === 'custom' ? (item.keywords ?? item.value) : item.value
		if (string) {
...
ImageProperty.initialize = function () {
	...
	// 设置属性关联元素
	$('#setImage-property-key')
		.enableHiddenMode()
		.relate([
			{ case: 'image', targets: [$('#setImage-property-image')] },
			{ case: 'display', targets: [$('#setImage-property-display')] },
			{ case: 'flip', targets: [$('#setImage-property-flip')] },
			{ case: 'blend', targets: [$('#setImage-property-blend')] },
			{ case: 'shiftX', targets: [$('#setImage-property-shiftX')] },
			{ case: 'shiftY', targets: [$('#setImage-property-shiftY')] },
			{ case: 'clip-0', targets: [$('#setImage-property-clip-0')] },
			{ case: 'clip-1', targets: [$('#setImage-property-clip-1')] },
			{ case: 'clip-2', targets: [$('#setImage-property-clip-2')] },
			{ case: 'clip-3', targets: [$('#setImage-property-clip-3')] }
		])
...
TextBoxProperty.initialize = function () {
	...
	// 设置属性关联元素
	$('#setTextBox-property-key')
		.enableHiddenMode()
		.relate([
			{ case: 'type', targets: [$('#setTextBox-property-type')] },
			{ case: 'text', targets: [$('#setTextBox-property-text')] },
			{ case: 'number', targets: [$('#setTextBox-property-number')] },
			{ case: 'min', targets: [$('#setTextBox-property-min')] },
			{ case: 'max', targets: [$('#setTextBox-property-max')] },
			{ case: 'decimals', targets: [$('#setTextBox-property-decimals')] },
			{ case: 'color', targets: [$('#setTextBox-property-color')] }
		])
	...
	switch (key) {
		...
		case 'text': {
			...
			string =
				name +
				Token('(') +
				Command.parseVariableString(text) +
				Token(')')
			break
		}
		case 'number':
...
ProgressBarProperty.initialize = function () {
	...
	// 设置属性关联元素
	$('#setProgressBar-property-key')
		.enableHiddenMode()
		.relate([
			{ case: 'image', targets: [$('#setProgressBar-property-image')] },
			{
				case: 'display',
				targets: [$('#setProgressBar-property-display')]
			},
			{ case: 'blend', targets: [$('#setProgressBar-property-blend')] },
			{
				case: 'progress',
				targets: [$('#setProgressBar-property-progress')]
			},
			{ case: 'clip-0', targets: [$('#setProgressBar-property-clip-0')] },
			{ case: 'clip-1', targets: [$('#setProgressBar-property-clip-1')] },
			{ case: 'clip-2', targets: [$('#setProgressBar-property-clip-2')] },
			{ case: 'clip-3', targets: [$('#setProgressBar-property-clip-3')] },
			{
				case: 'color-0',
				targets: [$('#setProgressBar-property-color-0')]
			},
			{
				case: 'color-1',
				targets: [$('#setProgressBar-property-color-1')]
			},
			{
				case: 'color-2',
				targets: [$('#setProgressBar-property-color-2')]
			},
			{
				case: 'color-3',
				targets: [$('#setProgressBar-property-color-3')]
			}
		])
...
TransformProperty.initialize = function () {
	...
	// 设置属性关联元素
	$('#moveElement-property-key')
		.enableHiddenMode()
		.relate([
			{ case: 'anchorX', targets: [$('#moveElement-property-anchorX')] },
			{ case: 'anchorY', targets: [$('#moveElement-property-anchorY')] },
			{ case: 'x', targets: [$('#moveElement-property-x')] },
			{ case: 'y', targets: [$('#moveElement-property-y')] },
			{ case: 'width', targets: [$('#moveElement-property-width')] },
			{ case: 'height', targets: [$('#moveElement-property-height')] },
			{ case: 'x2', targets: [$('#moveElement-property-x2')] },
			{ case: 'y2', targets: [$('#moveElement-property-y2')] },
			{ case: 'width2', targets: [$('#moveElement-property-width2')] },
			{ case: 'height2', targets: [$('#moveElement-property-height2')] },
			{
				case: 'rotation',
				targets: [$('#moveElement-property-rotation')]
			},
			{ case: 'scaleX', targets: [$('#moveElement-property-scaleX')] },
			{ case: 'scaleY', targets: [$('#moveElement-property-scaleY')] },
			{ case: 'skewX', targets: [$('#moveElement-property-skewX')] },
			{ case: 'skewY', targets: [$('#moveElement-property-skewY')] },
			{ case: 'opacity', targets: [$('#moveElement-property-opacity')] }
		])
...
TransformProperty.parse = function ({ key, value }, listData) {
	...
	let string =
		Local.get('command.moveElement.' + key) +
		Token('(') +
		number +
		Token(')')
	if (listData) {
...
LightProperty.initialize = function () {
	...
	// 设置属性关联元素
	$('#moveLight-property-key')
		.enableHiddenMode()
		.relate([
			{ case: 'x', targets: [$('#moveLight-property-x')] },
			{ case: 'y', targets: [$('#moveLight-property-y')] },
			{ case: 'range', targets: [$('#moveLight-property-range')] },
			{
				case: 'intensity',
				targets: [$('#moveLight-property-intensity')]
			},
			{ case: 'anchorX', targets: [$('#moveLight-property-anchorX')] },
			{ case: 'anchorY', targets: [$('#moveLight-property-anchorY')] },
			{ case: 'width', targets: [$('#moveLight-property-width')] },
			{ case: 'height', targets: [$('#moveLight-property-height')] },
			{ case: 'angle', targets: [$('#moveLight-property-angle')] },
			{ case: 'red', targets: [$('#moveLight-property-red')] },
			{ case: 'green', targets: [$('#moveLight-property-green')] },
			{ case: 'blue', targets: [$('#moveLight-property-blue')] }
		])
...
LightProperty.parse = function ({ key, value }, listData) {
	const number = Command.parseVariableNumber(value)
	let string =
		Local.get('command.moveLight.' + key) + Token('(') + number + Token(')')
	if (listData) {
		string = Command.removeTextTags(string)
	}
	return string
